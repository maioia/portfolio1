    ...
    <>
      <main className="container">
        <section className="home-section flex lg:flex-row flex-col gap-2 justify-center items-center min-h-screen">
          ...
          <div className="home-text lg:p-5 lg:space-y-8 relative before:absolute lg:before:left-3 lg:before:w-[40px] before:w-[30px] before:h-[4px] before:rounded-xl before:bg-rose-900 lg:before:top-[17%] before:top-[3%]">
            ...
            <div className="space-y-7">
              ...
              <p className="home-description lg:text-xl md:text-lg lg:leading-12 lg:w-xl">
                ...
                performant, and beautiful web applications. I have an eye
                for details and can utilize innovative skills in designing.
              </p>
            </div>
            <Link
              to="/about"
              className="bg-rose-300 border-2 border-white rounded-lg shadow-md px-3 py-2 my-4 lg:text-sm hover:bg-rose-900 hover:text-white transition-all duration-400 ease-in-out"
            >
